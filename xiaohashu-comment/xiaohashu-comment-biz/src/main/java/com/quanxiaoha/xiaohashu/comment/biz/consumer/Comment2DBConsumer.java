 ...
 * @Description: 评论批量写库 自定义创建 DefaultMQPushConsumer，注入到 Spring 容器中
 */
@Component
@Slf4j
public class Comment2DBConsumer {
    ...
    public DefaultMQPushConsumer mqPushConsumer() throws MQClientException {
        ...
        // 设置每批次消费的最大消息数量，默认值为 32 这里设置为 30，表示每次拉取时最多消费 30 条消息
            ...
            try {
                ...
                for (PublishCommentMqDTO publishCommentMqDTO : publishCommentMqDTOS) {
                    ...
                    CommentBO commentBO = CommentBO.builder()
                            ...
                            .updateTime(publishCommentMqDTO.getUpdateTime())
                            .isTop(false)
                            .replyTotal(0L)
                            .likeTotal(0L)
                            .replyCommentId(0L)
