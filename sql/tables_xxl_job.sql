...
INSERT INTO xxl_job.xxl_job_group (app_name,title,address_type,address_list,update_time) VALUES
('xxl-job-executor-xiaohashu','小哈书执行器',0,NULL,'2025-06-14 09:54:05');
...
(1,'创建计数日增量变更表任务','2025-06-12 18:11:48','2025-06-12 21:55:53','犬小哈','1431954069@qq.com',
 'CRON','0 0 23 * * ?','DO_NOTHING','RANDOM','createTableJobHandler','','SERIAL_EXECUTION',0,0,
 'BEAN','','GLUE代码初始化','2025-06-12 18:11:48','',0,0,0),
(1,'删除计数日增量变更表任务','2025-06-13 14:04:50','2025-06-13 14:07:44','犬小哈','1431954069@qq.com',
 'CRON','0 0 23 * * ?','DO_NOTHING','RANDOM','deleteTableJobHandler','','SERIAL_EXECUTION',0,0,
 'BEAN','','GLUE代码初始化','2025-06-13 14:04:50','',0,0,0);
