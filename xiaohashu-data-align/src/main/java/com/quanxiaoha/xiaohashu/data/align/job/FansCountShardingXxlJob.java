...
public class FansCountShardingXxlJob {
    ...
    public void fansCountShardingJobHandler() throws Exception {
        ...
        for (;;) {
            ...
            List<Long> userIds = selectMapper.selectBatchFromDataAlignFansCountTempTable(
                    tableNameSuffix, batchSize);
        ...
        XxlJobHelper.log("=================> 结束定时分片广播任务：对当日发生变更的用户关注数进行对齐，共对齐记录数：{}",
                processedTotal);
    }
}
