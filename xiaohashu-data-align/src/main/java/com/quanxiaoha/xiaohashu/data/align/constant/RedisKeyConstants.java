...
public class RedisKeyConstants {
    ...
    /**
     * 构建完整的布隆过滤器：日增量变更数据，用户笔记点赞，取消点赞(笔记ID) KEY 记录noteId
     * @param date
     * @return
     */
    ...
    /**
     * 构建完整的布隆过滤器：日增量变更数据，用户笔记点赞，取消点赞(笔记发布者ID) KEY 记录userId
     * @param date
     * @return
     */
    ...
    /**
     * 构建完整的布隆过滤器：日增量变更数据，用户笔记收藏，取消收藏 KEY 记录noteId
     * @param date
     * @return
     */
    public static String buildBloomUserNoteCollectNodeIdListKey(String date) {
        return BLOOM_TODAY_NOTE_COLLECT_NOTE_ID_LIST_KEY + date;
    }

    /**
     * 构建完整的布隆过滤器：日增量变更数据，用户笔记收藏，取消收藏 KEY 记录userId
     * @param date
     * @return
     */
